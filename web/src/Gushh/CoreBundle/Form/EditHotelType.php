...
class EditHotelType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('checkIn', 'html5time', array(
                'attr' => array(
                    'class'       => 'form-control'
                )
            ))
            ->add('checkOut', 'html5time', array(
                'attr' => array(
                    'class'       => 'form-control'
                )
            ))
            ->add('reservationEmail', 'email', array(
                'attr' => array(
                    'class'       => 'form-control',
                    'placeholder' => 'Reservation email'
                )
            ))
            ->add('cancellationEmail', 'email', array(
                'attr' => array(
                    'class'       => 'form-control',
                    'placeholder' => 'Cancellation email'
                )
            ))
            ->add('coords', 'hidden', array(
                'attr' => array(
                    'class'       => 'form-control',
