 ...
 *
 * @ORM\Table(name="reservation_payment_status")
 * @ORM\Entity(repositoryClass="Gushh\CoreBundle\Entity\ReservationPaymentStatusRepository")
 */
class ReservationPaymentStatus
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Reservation", mappedBy="paymentStatus")
     */
