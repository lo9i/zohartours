 ...
 *
 * @ORM\Table(name="promotion_benefit_type")
 * @ORM\Entity(repositoryClass="Gushh\CoreBundle\Entity\PromotionBenefitTypeRepository")
 * @ORM\HasLifecycleCallbacks()
 */
class PromotionBenefitType
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="PromotionBenefit", mappedBy="type")
     */
    protected $benefits;
