...
/**
 * ClientFileItemStatus
 *
 * @ORM\Table()
 * @ORM\Entity
 */
class ClientFileItemStatus
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="ClientFileItem", mappedBy="status")
     */
     ...
     * Set status
     *
     * @param \Gushh\CoreBundle\Entity\ClientFileItemStatus $status
